...
public class Reimbursements extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if ((rr != null) && !rr.isEmpty()) {
			...
			out.println(
					"<table border = '2px' class='table table-hover table-striped table-condensed'><tr><th>ID</th><th>EMP ID</th><th>COST</th>"
							+ "<th>EVENT TYPE</th><th>STATUS</th><th>TIMESTAMP</th><th>DATE</th><th>TIME OFF START DATE</th><th>TIME OFF END DATE</th><th>LOCATION</th><th>COVERED COST</th></tr>");
		...
		out.println("<hr>" + "<a href='employee.html'>BACK</a>");
		out.close();
	}
